...
class MessageBuilder {
   ...
   */
  setTTS(tts) {
    if (typeof tts ?? false != "boolean")
      throw new Error("TypeError: TTS must be a boolean value.");
    this.tts = tts ?? false;
    return this;
  }
  ...
  setNonce(nonce) {
    if (typeof nonce ?? "" != "string")
      throw new Error("TypeError: Nonce must be a string value.");
    this.nonce = nonce ?? "";
    return this;
  }
  ...
  setContent(content) {
    if (typeof content ?? "" != "string")
      throw new Error("TypeError: Content must be a string value.");
  ...
  setEmbeds(embeds) {
    let embeds1 = embeds ?? [];
    if (!Array.isArray(embeds1))
      throw new Error("TypeError: Embeds must be an array.");
  ...
  setAllowedMentions(allowedMentions) {
    if (typeof allowedMentions ?? "" != "string")
      throw new Error("TypeError: AllowedMentions must be a string value.");
  ...
  setFiles(files) {
    ...
    if (!Array.isArray(files1))
      throw new Error("TypeError: Files must be an array.");
    this.files = files1;
    return this;
  }
  ...
  setComponents(components) {
    ...
    if (!Array.isArray(components1))
      throw new Error("TypeError: Components must be an array.");
  ...
  setAttachments(attachments) {
    ...
    if (!Array.isArray(attachments1))
      throw new Error("TypeError: Attachments must be an array.");
  ...
  setReply(reply) {
    ...
    if (typeof reply1 != "object" && reply1 != null)
      throw new Error("TypeError: Reply must be an object or null.");
    this.reply = reply;
    return this;
  }
  ...
  setStickers(stickers) {
    ...
    if (!Array.isArray(stickers1))
      throw new Error("TypeError: Stickers must be an array.");
  ...
  setFlags(flags) {
    ...
    if (typeof flags1 != "number" && flags != null)
      throw new Error("TypeError: Flags must be a number or array");
    this.flags = flags1;
    return this;
  }
}
