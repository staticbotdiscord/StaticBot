...
module.exports = {
  ...
  async execute(client, interaction, options) {
    ...
    const embed2 = new EmbedBuilder()
      .setDescription(
        locales2[interaction.locale] ?? "I don't have permission to ban members"
      )
      .setColor("#c71212");
    if (
      ...
      return await interaction.editReply({ content: null, embeds: [embed2] });
    ...
    if (moderationPosition <= memberPosition)
      return await interaction.editReply({ content: null, embeds: [embed3] });
    const locales4 = {
    ...
    if (myPosition <= memberPosition)
      return await interaction.editReply({ content: null, embeds: [embed4] });
    const locales = {
